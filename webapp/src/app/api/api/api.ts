...
export const APIS = [AuthControllerService, BasicErrorControllerService, OrderControllerService, ProductControllerService, RatingSystemControllerService, ResourceControllerService, UserControllerService];
